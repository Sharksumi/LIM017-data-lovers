...
import { filtergeneration, orderPokemonAscendent, orderPokemonDescendent, groupEggs, orderPokemons } from '../src/data.js';
 const pokemonList =
 [{
  "num": "001",
  "name": "bulbasaur",
...
describe('order-pokemon-ascendet', () => {
 ...
 describe('orderPokemons', () => {
  it('una fx de ordenamiento de pokemon 001 al pokemon 251', () => {
    expect(orderPokemons(pokemonList,"num")).toEqual(arrayOrderNumber);
  });
